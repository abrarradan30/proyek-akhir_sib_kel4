    ...
    <h1 align="center"> Form Tambah Riwayat Pesanan </h2>
        ...
        <form method="POST" action="{{ url('admin/riwayat_pesanan/store') }}" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                    <input id="text1" name="no_kwitansi" type="text"
            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                    <input id="text1" name="tanggal" type="date"
            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                    ...
                    <div class="custom-control custom-radio custom-control-inline">
                        <input name="status" id="radio_1" type="radio" class="custom-control-input"
                            value="belum lunas">
            ...
            <div class="form-group row">
                <label for="select2" class="col-4 col-form-label">Durasi Sewa</label>
                <div class="col-8">
                    <select id="select2" name="pembayaran_id" class="custom-select">
                        @foreach ($pembayaran as $py)
                            <option value="{{ $py->id }}">{{ $py->durasi_sewa }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            <div class="form-group row">
                <label for="select2" class="col-4 col-form-label">Jumlah Kamar</label>
                <div class="col-8">
                    <select id="select2" name="pembayaran_id" class="custom-select">
                        @foreach ($pembayaran as $py)
                            <option value="{{ $py->id }}">{{ $py->jumlah_kamar }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-8">
                    <select id="select2" name="pembayaran_id" class="custom-select">
                        @foreach ($pembayaran as $py)
                            <option value="{{ $py->id }}">{{ $py->tanggal }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            <div class="form-group row">
                <label for="select2" class="col-4 col-form-label">Total Bayar</label>
                <div class="col-8">
                    <select id="select2" name="pembayaran_id" class="custom-select">
                        @foreach ($pembayaran as $py)
                            <option value="{{ $py->id }}">{{ $py->total }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
