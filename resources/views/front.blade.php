        ...
        <div class="row">
          ...
          <!-- <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="section-title-header text-center">
                            <a href="{{ url('daftar_kos') }}" rel="nofollow" class="btn btn-danger btn-lg">Cari
                                Kos</a>
                        </div>
                        <div class="section-title-header text-center">
                            <a href="{{ url('form_pemilikkos') }}" rel="nofollow" class="btn btn-warning btn-lg">Sewakan
                                Kos</a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-6 col-md-12 col-xs-12">
                            <div class="featured-item">
                                ...
                                <div class="featured-content">
                                    <p align="justify">Kami sangat memperhatikan para pelanggan yang ingin menyewa kamar
                                        kos-kosan di website kami.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-12 col-xs-12">
                            <div class="featured-item">
                                ...
                                <div class="featured-content">
                                    <p align="justify">Kami memberi informasi sesuai dengan kenyataan yang ada di lapangan.
                                        Jadi jangan ragu untuk berkunjung di website kami.</p>
                                </div>
                            </div>
                        </div>
                    </div>
...
>>>>>>> 41a46112217f48c668bd31746bc844767c682414
            </div>
        </div>
    </section>
